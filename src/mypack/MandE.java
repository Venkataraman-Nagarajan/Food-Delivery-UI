 ...
 */
public class MandE extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("MEAT AND EAT");

        jCheckBox1.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jCheckBox1.setText("CHICKEN BUCKET");
        ...
        jCheckBox4.setText("CHICKEN LOADED POPCORN");
    ...
    private void jCheckBox4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox4ActionPerformed
        ...
        Orders ordersobj=new Orders();
        Suborder subobj=new Suborder();
        subobj.dish="chicken loaded popcorn";
    ...
    private void jCheckBox5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox5ActionPerformed
        ...
        Orders ordersobj=new Orders();
        Suborder subobj=new Suborder();
        subobj.dish="chicken pasta";
        subobj.quantity=(int) jSpinner5.getValue();
        subobj.cost=subobj.quantity*140;
        subobj.hotel="Meat and eat";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MandE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
